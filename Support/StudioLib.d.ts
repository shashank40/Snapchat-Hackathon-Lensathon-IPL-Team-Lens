// Lens Studio Version: 4.40.0
// Snapchat Version: 12.20
...
declare namespace GltfSettings {
    /**
    * @description Creates a new GltfSettings object to be passed in to `gltfAsset.tryInstantiateWithSetting`.
    */
